...
$result2 = $conn->query("SELECT * FROM tovar ORDER BY rating DESC LIMIT 4");
...
<head>
    ...
    <meta name="description" content="Доставка цветов по Москве, Санкт-Петербургу, Екатеринбургу и всей России. 
    Свежие букеты от 1 490 ₽. Круглосуточный прием заказов. Закажите цветы с доставкой на дом или в офис. 
    ...
    <title>Sakura | Главная страница</title>
</head>
<body>
    ...
    <div id="cookieMenu" class="cookie-menu" style="display: none;">
        <div class="cookie-content">
            <p>
                🍪 Мы используем cookie-файлы для улучшения работы сайта. 
                Продолжая использовать наш сайт, вы соглашаетесь с 
                <a href="#">политикой обработки cookie</a>.
            </p>
            <div class="cookie-buttons">
                <button class="cookie-btn cookie-btn-decline">Отклонить</button>
                <button class="cookie-btn cookie-btn-settings">Настройки</button>
    ...
    $(document).ready(function() {
        // Показываем меню при каждой загрузке страницы
        $('#cookieMenu').css('display', 'flex').hide().slideDown(500);
        
        // Обработчик кнопки "Принять"
        $('.cookie-btn-accept').on('click', function() {
            $('#cookieMenu').slideUp(500);
        });
        ...
        $('.cookie-btn-settings').on('click', function() {
            $('#cookieMenu').slideUp(500);
            alert('Настройки cookie будут доступны в следующей версии');
        });
    });
    </script>
</script>
